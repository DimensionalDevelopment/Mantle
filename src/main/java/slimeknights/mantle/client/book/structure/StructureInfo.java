...
public class StructureInfo implements Predicate<BlockPos> {
  ...
  public Map<BlockPos, Structure.StructureBlockInfo> data = new HashMap<>();
  ...
  public StructureInfo(List<Structure.StructureBlockInfo> structure) {
    int structureHeight = 0;
    int structureWidth = 0;
    int structureLength = 0;

    for (Structure.StructureBlockInfo block : structure) {
