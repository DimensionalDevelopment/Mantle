...
{
  static IModelBuilder<?> of(JsonUnbakedModel owner, ModelOverrideList overrides, Sprite particle)
  {
    return new Simple(new BasicBakedModel.Builder(owner, overrides, true).setParticle(particle));
  }
